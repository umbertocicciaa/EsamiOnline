...
public class ExamMappingProfile : Profile
{
    public ExamMappingProfile()
    {
        ...
        CreateMap<ExamDto, ExamEntity>()
            ...
            .ForMember(dest => dest.ExamDateTime,
                opt => opt.MapFrom(src => new BsonDateTime(src.ExamDatetime.ToDateTime())))
        ...
        CreateMap<ExamEntity, ExamDto>()
            ...
            .ForMember(dest => dest.ExamDatetime,
                opt => opt.MapFrom(src =>
                    src.ExamDateTime != null ? Timestamp.FromDateTime(src.ExamDateTime.ToUniversalTime()) : null))
